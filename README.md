...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9y1032c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9y1032c.containers.anotherwebservice.com/
...
```
git clone git@github.com:devandris/container-9y1032c.git
cd container-9y1032c
```
...
```
docker attach container-9y1032c
```
